...
regression) and other inference engines.  On the other hand, BayesPy is
open-source software and supports several advanced VB methods (e.g., stochastic
variational inference and collapsed inference).
...
stochastic variational inference.  The accuracy could be improved by using
